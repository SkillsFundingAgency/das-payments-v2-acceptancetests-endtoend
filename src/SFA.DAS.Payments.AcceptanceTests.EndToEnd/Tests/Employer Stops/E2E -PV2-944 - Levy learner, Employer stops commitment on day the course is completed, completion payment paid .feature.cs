...
namespace SFA.DAS.Payments.AcceptanceTests.EndToEnd.Tests.EmployerStops
{
    ...
    [NUnit.Framework.DescriptionAttribute("Employer Stops PV2-944")]
    public partial class EmployerStopsPV2_944Feature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "E2E -PV2-944 - Levy learner, Employer stops commitment on day the course is completed, completion payment paid .feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Employer Stops PV2-944", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Levy learner, Employer stops commitment on the day that the course is completed. " +
            "Completion payment is paid")]
        [NUnit.Framework.TestCaseAttribute("R01/Current Academic Year", "15000", null)]
        public virtual void LevyLearnerEmployerStopsCommitmentOnTheDayThatTheCourseIsCompleted_CompletionPaymentIsPaid(string collection_Period, string levyBalance, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Levy learner, Employer stops commitment on the day that the course is completed. " +
                    "Completion payment is paid", null, exampleTags);
#line 43
...
#line 48
 testRunner.And("the following apprenticeships exist", ((string)(null)), table495, "And ");
#line hidden
            ...
            table496.AddRow(new string[] {
                        ...
                        "90%"});
#line 52
 testRunner.And("the provider previously submitted the following learner details", ((string)(null)), table496, "And ");
#line hidden
            ...
            table497.AddRow(new string[] {
                        ...
                        "0"});
#line 55
    testRunner.And("the following earnings had been generated for the learner", ((string)(null)), table497, "And ");
#line hidden
            ...
            table498.AddRow(new string[] {
                        ...
                        "Learning"});
#line 70
    testRunner.And("the following provider payments had been generated", ((string)(null)), table498, "And ");
#line hidden
            ...
            table499.AddRow(new string[] {
                        ...
                        "90%"});
#line 84
    testRunner.But("the Provider now changes the Learner details as follows", ((string)(null)), table499, "But ");
#line hidden
            ...
            table500.AddRow(new string[] {
                        ...
                        "90%"});
#line 87
 testRunner.And("price details are changed as follows", ((string)(null)), table500, "And ");
#line 92
...
#line hidden
            ...
            table501.AddRow(new string[] {
                        ...
                        "pe-1"});
#line 93
 testRunner.Then("the following learner earnings should be generated", ((string)(null)), table501, "Then ");
#line hidden
            ...
            table502.AddRow(new string[] {
                        ...
                        "0"});
#line 107
    testRunner.And("at month end only the following payments will be calculated", ((string)(null)), table502, "And ");
#line hidden
            ...
            table503.AddRow(new string[] {
                        ...
                        "Completion"});
#line 111
 testRunner.And("only the following provider payments will be recorded", ((string)(null)), table503, "And ");
#line hidden
            ...
            table504.AddRow(new string[] {
                        ...
                        "Completion"});
#line 114
 testRunner.And("only the following provider payments will be generated", ((string)(null)), table504, "And ");
#line hidden
