...
namespace SFA.DAS.Payments.AcceptanceTests.EndToEnd.Tests.HoldingBackCompletionPayments
{
    ...
    [NUnit.Framework.DescriptionAttribute("Holding back completion payments - PV2-518")]
    public partial class HoldingBackCompletionPayments_PV2_518Feature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "PV2-518- Non-Levy Learner completion payment made due to LDM 356 not enough employer contribution.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Holding back completion payments - PV2-518", @"	As a provider,
	...
	So that I am accurately paid the completion payment by SFA", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Non-Levy Learner-in co-funding completion payment made due to LDM code not enough" +
            " employer contribution PV2-518")]
        ...
        public virtual void Non_LevyLearner_InCo_FundingCompletionPaymentMadeDueToLDMCodeNotEnoughEmployerContributionPV2_518(string collection_Period, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Non-Levy Learner-in co-funding completion payment made due to LDM code not enough" +
                    " employer contribution PV2-518", null, exampleTags);
#line 6
...
#line hidden
            ...
            table972.AddRow(new string[] {
                        ...
                        "90%"});
#line 8
 testRunner.Given("the provider previously submitted the following learner details", ((string)(null)), table972, "Given ");
#line hidden
            ...
            table973.AddRow(new string[] {
                        ...
                        "0"});
#line 12
 testRunner.And("the following earnings had been generated for the learner", ((string)(null)), table973, "And ");
#line hidden
            ...
            table974.AddRow(new string[] {
                        ...
                        "Learning"});
#line 27
 testRunner.And("the following provider payments had been generated", ((string)(null)), table974, "And ");
#line hidden
            ...
            table975.AddRow(new string[] {
                        ...
                        "2"});
#line 34
 testRunner.But("the Provider now changes the Learner details as follows", ((string)(null)), table975, "But ");
#line hidden
            ...
            table976.AddRow(new string[] {
                        ...
                        "90%"});
#line 38
 testRunner.And("price details as follows", ((string)(null)), table976, "And ");
#line 42
...
#line hidden
            ...
            table977.AddRow(new string[] {
                        ...
                        "pe-1"});
#line 44
 testRunner.Then("the following learner earnings should be generated", ((string)(null)), table977, "Then ");
#line hidden
            ...
            table978.AddRow(new string[] {
                        ...
                        "0"});
#line 59
 testRunner.And("at month end only the following payments will be calculated", ((string)(null)), table978, "And ");
#line hidden
            ...
            table979.AddRow(new string[] {
                        ...
                        "Completion"});
#line 73
 testRunner.And("only the following provider payments will be recorded", ((string)(null)), table979, "And ");
#line hidden
            ...
            table980.AddRow(new string[] {
                        ...
                        "Completion"});
#line 87
 testRunner.And("only the following provider payments will be generated", ((string)(null)), table980, "And ");
#line hidden
