...
namespace SFA.DAS.Payments.AcceptanceTests.EndToEnd.Tests.HoldingBackCompletionPayments
{
    ...
    [NUnit.Framework.DescriptionAttribute("Holding back completion payments - PV2-519")]
    public partial class HoldingBackCompletionPayments_PV2_519Feature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "PV2-519 - Levy Learner-co-funded sufficient employer contribution LDM code 361- pay.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Holding back completion payments - PV2-519", @"	As a provider,
	...
	So that I am accurately paid the completion payment by SFA", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Levy Learner-co-funded,sufficient employer contribution LDM code 361 - pay comple" +
            "tion PV2-519")]
        ...
        public virtual void LevyLearner_Co_FundedSufficientEmployerContributionLDMCode361_PayCompletionPV2_519(string collection_Period, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Levy Learner-co-funded,sufficient employer contribution LDM code 361 - pay comple" +
                    "tion PV2-519", null, exampleTags);
#line 6
...
#line hidden
            ...
            table981.AddRow(new string[] {
                        ...
                        "20"});
#line 10
 testRunner.And("the following commitments exist", ((string)(null)), table981, "And ");
#line hidden
...
#line 14
 testRunner.And(string.Format("the provider previously submitted the following learner details in collection per" +
                        "iod \"{0}\"", collection_Period), ((string)(null)), table982, "And ");
#line hidden
            ...
            table983.AddRow(new string[] {
                        ...
                        "0"});
#line 18
 testRunner.And("the following earnings had been generated for the learner", ((string)(null)), table983, "And ");
#line hidden
            ...
            table984.AddRow(new string[] {
                        ...
                        "Learning"});
#line 33
 testRunner.And("the following provider payments had been generated", ((string)(null)), table984, "And ");
#line hidden
            ...
            table985.AddRow(new string[] {
                        ...
                        "3"});
#line 39
 testRunner.But("the Provider now changes the Learner details as follows", ((string)(null)), table985, "But ");
#line hidden
            ...
            table986.AddRow(new string[] {
                        ...
                        "90%"});
#line 43
 testRunner.And("price details as follows", ((string)(null)), table986, "And ");
#line 47
...
#line hidden
            ...
            table987.AddRow(new string[] {
                        ...
                        "pe-1"});
#line 49
 testRunner.Then("the following learner earnings should be generated", ((string)(null)), table987, "Then ");
#line hidden
            ...
            table988.AddRow(new string[] {
                        ...
                        "0"});
#line 64
 testRunner.And("at month end only the following payments will be calculated", ((string)(null)), table988, "And ");
#line hidden
            ...
            table989.AddRow(new string[] {
                        ...
                        "Completion"});
#line 78
 testRunner.And("only the following provider payments will be recorded", ((string)(null)), table989, "And ");
#line hidden
            ...
            table990.AddRow(new string[] {
                        ...
                        "Completion"});
#line 92
 testRunner.And("only the following provider payments will be generated", ((string)(null)), table990, "And ");
#line hidden
